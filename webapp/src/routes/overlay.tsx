    ...
    return (
        <MainPane className="max-w-[800px]" title="Overlay">
            ...
            <div className="glass-inner p-10 round mb-[2rem] mt-[2rem]">
                <h2>Instructions</h2>
                <p>To get our in-game overlay, head over to our page on BakkesMod, linked <a href={bakkesModURL}>here.</a></p>
                <ol>
                ...
                <p>If you have any problem getting the overlay to work, you can reach out to us on our Discord server <a href={discordURL}>here.</a></p>
            </div>

            {/* Kinda sucks, that I have to fix it like this, but I'll have to investigate why this is causing so much of an issue*/}
            <div className="flex justify-center">
                <a className="primary-btn px-[3rem]" href={bakkesModURL}>Go to Bakkes Page</a>
            </div>
        </MainPane>
