  ...
  return (
    <MainPane title="Settings" className="settings">
      ...
      <div className="glass-inner p-10 round mt-10">
          <h2>Warning</h2>
          <p className={warningParagraphClasses}>If you delete your account, all replays and preferences associated with the account will be removed from our servers. While you can always re-create your account by logging in to our platform via Steam or Epic Games again, your previous data will be retrievable</p>
      </div>
