...
const GROUPS: { groupName: string, tabs: { tabName: string, content: JSX.Element}[]}[] = [
    { groupName: "Group 1", tabs: [
        { tabName: "Page 1", content: <h1 className="text-center">Content 1</h1>},
        ...
        <MainPane className="mx-[5%]" title="Replay">
            ...
            <Tab.Group>
                <div className="flex mt-4 space-x-4" >
                    <div className="glass-inner rounded-2xl w-[15%] pt-6 p-8" >
                        <div className="">
                    ...
                    <div className="glass-inner rounded-2xl w-[85%] pt-6 p-8" >
